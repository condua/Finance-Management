  ...
  return (
    <View style={[styles.item, style]}>
      <View style={{ flexDirection: "row", gap: 12 }}>
        ...
        <View style={styles.info}>
          ...
          <ThemedText
            ...
            color={NeutralColor.Black[300]}
          >
            {categoriesDefault.includes(category)
      ...
      <View style={styles.amount}>
        ...
        >
          {shortenAmount
            ? abbrValueFormat(amount, showCurrency, currencyCode)
            : formatValue({
                value: String(amount),
